...
class DeliveryReportMaterialFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnReportDelivery.setOnClickListener {
            sms?.sendTextMessage("+254723680624",null,"Delivered! Your farm product has been delivered successfully...Please confirm by entering your secret code",sentPendingIntent,deliveredPendingIntent)
        }
